...
export default function SignupPage() {
  ...
  return (
    <div className="w-full min-w-0 max-w-md rounded-2xl border border-white/10 bg-slate-900/80 p-4 shadow-[0_24px_70px_rgba(2,6,23,0.45)] backdrop-blur-xl sm:p-6">
      <h1 className="mb-4 break-words text-xl font-bold text-slate-100">Créer un compte</h1>
      <form action={handleSubmit} className="space-y-3">
        ...
        <div>
          ...
          <input
            ...
            name="username"
            required
            className="w-full rounded-lg border border-white/10 bg-slate-950/60 px-3.5 py-2 text-slate-100 placeholder:text-slate-400 focus:border-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-400/30"
